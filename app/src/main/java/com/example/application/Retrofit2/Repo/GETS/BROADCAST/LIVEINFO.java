...
public class LIVEINFO {
    ...
    public String getLive_stream_like() {
        return live_stream_like;
    }

    public void setLive_stream_like(String live_stream_like) {
        this.live_stream_like = live_stream_like;
    }
